...
(
	...
	CONSTRAINT FK_EXTRACT_BATCH FOREIGN KEY (APP_ID) REFERENCES VPI.PRE_DEPLOY_APP (APP_ID)
);

CREATE INDEX VPI.IX_EXTRACT_BATCH_APP ON VPI.EXTRACT_BATCH (APP_ID);
...
COMMENT ON COLUMN VPI.EXTRACT_BATCH.APP_ID
