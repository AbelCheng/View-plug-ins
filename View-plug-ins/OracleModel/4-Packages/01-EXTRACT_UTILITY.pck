...
BEGIN
	...
	RETURNING LAST_VERSION	INTO tVersion;
...
BEGIN
	...
	FOR S IN (SELECT INTERFACE_ID, PLUGIN_UNION_VIEW, PLUGIN_UNION_VIEW_CODE, RULE_VIEW, RULE_VIEW_CODE FROM VPI.VIEW_CODE_GENERATION WHERE SERVICE_ID = inService_ID)
	LOOP
